...
@AllArgsConstructor
@NoArgsConstructor
public class AliCertificationInitializeResult implements Result {
     ...
     * 返回结果
     */
    private ZhimaCustomerCertificationInitializeResponse response;

    public AliCertificationInitializeResult(ZhimaCustomerCertificationInitializeResponse response) {
