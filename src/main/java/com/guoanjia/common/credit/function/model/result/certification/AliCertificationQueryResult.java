...
@AllArgsConstructor
@NoArgsConstructor
public class AliCertificationQueryResult implements Result {
     ...
     * 返回结果
     */
    private ZhimaCustomerCertificationQueryResponse response;

    public AliCertificationQueryResult(ZhimaCustomerCertificationQueryResponse response) {
