...
@AllArgsConstructor
@NoArgsConstructor
public class AliCreditScoreBriefResult implements Result {
     ...
     * 返回结果
     */
    private ZhimaCreditScoreBriefGetResponse response;

    public AliCreditScoreBriefResult(ZhimaCreditScoreBriefGetResponse response) {
