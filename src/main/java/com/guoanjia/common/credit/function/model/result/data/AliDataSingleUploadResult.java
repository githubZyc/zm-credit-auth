...
@AllArgsConstructor
@NoArgsConstructor
public class AliDataSingleUploadResult implements Result {
     ...
     * 返回结果
     */
    private ZhimaMerchantSingleDataUploadResponse response;

    public AliDataSingleUploadResult(ZhimaMerchantSingleDataUploadResponse response) {
