...
@AllArgsConstructor
@NoArgsConstructor
public class AliCreditWatchlistBriefResult implements Result {
     ...
     * 返回结果
     */
    private ZhimaCreditWatchlistBriefGetResponse response;

    public AliCreditWatchlistBriefResult(ZhimaCreditWatchlistBriefGetResponse response) {
