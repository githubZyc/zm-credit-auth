...
@AllArgsConstructor
@NoArgsConstructor
public class AliDataUploadInitializeResult implements Result {
     ...
     * 返回结果
     */
    private ZhimaMerchantDataUploadInitializeResponse response;

    public AliDataUploadInitializeResult(ZhimaMerchantDataUploadInitializeResponse response) {
