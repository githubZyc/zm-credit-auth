...
public class CertificationCertifyResult extends BaseResult implements Serializable {
     ...
     * 芝麻认证认证页面地址
     */
    @ApiModelProperty(value = "芝麻认证认证页面地址")
    private String url;

    /**
     * 一次认证的唯一标识,用于查询认证结果
     */
    @ApiModelProperty(value = "一次认证的唯一标识,用于查询认证结果")
