 ...
 * @version 1.0.00
 */
public interface AliDataService {
    DataUploadInitializeResult dataUploadInitialize(AliDataUploadInitializeRequest request);

    DataUploadResult dataSingleUpload(AliDataSingleUploadRequest request);

    DataUploadResult dataCloseloopUpload(AliDataCloseloopUploadRequest request);
}
