...
import com.guoanjia.common.credit.config.annotation.validator.ExcludeFiledValidator;
...
@Constraint(validatedBy = ExcludeFiledValidator.class)
public @interface ExcludeFiled {
